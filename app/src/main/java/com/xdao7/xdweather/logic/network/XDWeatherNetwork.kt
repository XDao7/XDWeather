...
import com.xdao7.xdweather.logic.network.callback.qweather.AirService
...
object XDWeatherNetwork {
    ...
    private val airService = ServiceCreator.create<AirService>(ServiceCreator.TYPE_QWEATHER)
    ...
    suspend fun getAir(id: String) = airService.getAir(id, BuildConfig.PRIVATE_QWEATHER_KEY).await()
